...
[source,java] 
---- 
include::{book-root}/security/src/main/java/bookmarks/Application.java[]
----
...
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/WebSecurityConfiguration.java[]
----
...
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/OAuth2Configuration.java[]
----
...
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/BookmarkResource.java[]
----
...
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/BookmarkRestController.java[]
----
...
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/BookmarkControllerAdvice.java[]
----
...
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/UserNotFoundException.java[]
----
