...
By grabbing the `resource` you can fetch it's "self" link via the `getRequiredLink()` method call using the 'SELF' relation parameter. This method yields a `Link` which you can
