...
All the code you saw easiler in the controller can be moved into this class. And by applying Spring Framework's `@Component`, this component
...
evolution of APIs may need to take a backseat. But don't pursue such premature optimization until until you measure.
...
Business logic inevitably builds up rules that involve processes. The risk of such systems if we often carry such server-side
...
To do some more exploring check out the following video by Spring team mate Oliver Gierke:

video::mQkf85S9UoQ[youtube]
