...
[source,java] 
---- 
include::{book-root}/rest/src/main/java/bookmarks/Application.java[]
----   
...
`security/src/main/java/bookmarks/BookmarkResource.java`
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/BookmarkResource.java[tag=code]
----
...
This controller serves up the whole collection, accepts new bookmarks, and also lets you retrieve an individual bookmark. Look closely to see how each operation is done, links and all.

To nicely handle exceptions, the following bit of Spring MVC controller advice is registered:

`security/src/main/java/bookmarks/BookmarkControllerAdvice.java`
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/BookmarkControllerAdvice.java[tag=code]
----
...
`security/src/main/java/bookmarks/UserNotFoundException.java`
[source,java]
----
include::{book-root}/security/src/main/java/bookmarks/UserNotFoundException.java[tag=code]
----
