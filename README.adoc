...
[source,java]
----
include::{book-root}/hateoas/src/main/java/bookmarks/BookmarkResource.java[]
----
...
[source,java]
----
include::{book-root}/hateoas/src/main/java/bookmarks/BookmarkRestController.java[]
----
...
It also uses Spring HATEOAS's `Link` API. It let's replace this:
...
[source,java]
----
include::{book-root}/hateoas/src/main/java/bookmarks/BookmarkControllerAdvice.java[]
----
...
[source,java]
----
include::{book-root}/hateoas/src/main/java/bookmarks/UserNotFoundException.java[]
----
