...
.Error 415 anyone?
==== 
If you're using Windows's Command Prompt and you got https://gist.github.com/UgmaDevelopment/abfea553b77312d156111769bf2c05ab[an error] on the previous command, you should either:


* not use Command Prompt in this tutorial--you'll save yourself some trouble and avoid the problem by https://www.atlassian.com/git/tutorials/git-bash[using bash] instead
or
* https://stackoverflow.com/a/22597714/5432315[escape your double quotes]
====
...
....
# The indicated part pipes the output to python and asks it to make your JSON pretty.
#                                  v------------------v 
curl -v localhost:8080/employees/1 | python -mjson.tool
....
====
...
Having already embraced the concept of Spring HATEOAS `ResourceAssembler` components, putting such logic in the `OrderModelAssembler`
